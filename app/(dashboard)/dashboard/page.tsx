  ...
  return (
    isLoading ? (
      <div className="flex flex-col items-center justify-center py-20">
        <div className="animate-spin rounded-full border-4 border-blue-200 border-t-blue-500 h-12 w-12 mb-6" />
        <p className="text-blue-500 text-lg font-semibold">Loading data...</p>
      </div>
    ) : (
        ...
        <>
          <div className="flex flex-col items-center justify-center text-center py-20">
            ...
            <p className="text-gray-500 mb-6">
              Start exploring and choose a suitable course to learn!
            </p>
